...
> = {
  "en-US": {
    ...
    scanHelper: "Use your mobile device to scan, then continue here.",
...
export default function Register() {
  ...
  const [hasScannedMfa, setHasScannedMfa] = useState(false);
  ...
  function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    if (showMfa && hasScannedMfa && mfaCode.length < 6) {
          ...
          {showPassword ? (
            <>
              ...
              {showMfa ? (
                ...
                >
                  <span className="mb-2 block text-[15px] font-medium leading-5 text-[#31302e]">
                    {hasScannedMfa ? copy.mfa : copy.scanTitle}
                  </span>
                  {hasScannedMfa ? (
                    <div>
                    ...
                    <div className="rounded-[8px] border border-[#e6e6e6] bg-white p-4 shadow-[0_1px_2px_rgba(0,0,0,0.04)]">
                      <div
                        ...
                        className="mx-auto grid size-[132px] grid-cols-9 grid-rows-9 gap-1 rounded-[4px] bg-white p-2"
                      >
                          ...
                          return (
                            <span
                              ...
                              className={`rounded-[1px] ${
                                isDot ? "bg-[#31302e]" : "bg-transparent"
                              }`}
                            />
                          );
                        })}
                      </div>
                      <p className="mt-3 text-center text-[13px] leading-5 text-[#615d59]">
                        {copy.scanHelper}
                      </p>
                      <button
                        type="button"
                        onClick={() => {
                          setHasScannedMfa(true);
