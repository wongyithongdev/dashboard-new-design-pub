        ...
        <div className="flex h-[var(--dashboard-header-h)] shrink-0 items-center justify-between border-b border-[#e5e7eb] px-4 sm:px-6 z-10">
          ...
          <div className="flex shrink-0 items-center gap-2">
            ...
            <button type="button"
              ...
              disabled={!creditorCode || !paymentDate || !paymentAmount || submitState !== "idle"}>
              Confirm Payment
            </button>
          </div>
        </div>
                  ...
                  {!creditorCode ? (
                    ...
                    <motion.div key="no-invoices" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
                      ...
                      <div className="relative w-[52px] h-[52px]">
                        <div className="w-full h-full rounded-full border-2 border-dashed border-[#d1d5db]" />
                        <div className="absolute inset-0 flex items-center justify-center">
                          <Check size={16} strokeWidth={1.8} className="text-[#86efac]" aria-hidden="true" />
                        </div>
                      </div>
                      <div>
                        <p className="text-[13px] font-medium text-[#374151]">All clear</p>
                        <p className="text-[12px] text-[#9ca3af] mt-1 leading-relaxed">No outstanding invoices<br />for this creditor</p>
                      </div>
                    </motion.div>
          ...
          <div className="px-4 py-3.5">
            <div className="flex items-center justify-between mb-3">
              <span className={`text-[13px] font-semibold ${submitState === "failed" ? "text-[#dc2626]" : "text-[#18181b]"}`}>
                {submitState === "completed" ? "Payment submitted" : submitState === "failed" ? "Submission failed" : "Submitting payment…"}
              </span>
