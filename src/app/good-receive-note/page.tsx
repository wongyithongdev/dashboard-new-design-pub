        ...
        >
          <section className="flex min-h-screen flex-col">
            ...
            <div className="flex h-[var(--dashboard-toolbar-h)] items-center justify-between gap-3 px-[var(--dashboard-main-x)]">
              ...
              <button
                type="button"
                className="inline-flex h-8 items-center gap-1.5 rounded-[7px] border border-[#2783DE] bg-[#2783DE] px-3 text-[14px] font-medium leading-5 text-white outline-none transition-colors duration-75 hover:bg-[#1f75ca] focus-visible:ring-2 focus-visible:ring-[#2783DE]/20"
              >
                    ...
                    {sortedHistory.map((history, index) => (
                      ...
                      >
                        ...
                        <td className="border-b border-[#f0efed] pl-3 pr-6 text-right">
                          <button
                            type="button"
                            className="inline-flex h-7 items-center rounded-[7px] border border-transparent px-2 text-[13px] font-medium leading-5 text-[#0075de] outline-none transition-colors duration-75 hover:border-[#cfe3fb] hover:bg-[#f7f7f8] focus-visible:border-[#cfe3fb] focus-visible:bg-[#f7f7f8]"
                          >
                            View
                          </button>
                        </td>
